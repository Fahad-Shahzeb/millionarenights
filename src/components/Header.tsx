    ...
    return (
        <div className='absolute top-0 left-0 w-full z-50'>
            <div className='flex flex-1 py-5 pr-10 pl-8 lg:pl-24  justify-between items-center'>
                <img
                    src={AppLogo_PNG}
                    className='w-10 h-9  md:w-14 md:h-14 mr-12'
                    alt=''
                />
                <div className='hidden lg2:flex justify-between w-full transition-all'>
                    ...
                    <button onClick={() => scrollToSection(5)} className='gradient-hover-effect cursor-pointer hidden lg:flex border-[2px] border-[#B8A8D8] font-extralight px-5 py-1 rounded-full text-white text-[16px]  text-center w-[143px] z-50 h-[45px] justify-center items-center leading-normal'>
                        {"Contact"}
                    </button>
                </div>
