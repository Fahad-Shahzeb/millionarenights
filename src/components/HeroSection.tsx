                ...
                <div className='flex basis-[60%] shrink-[1] flex-col  items-center  justify-center '>
                    <div className='flex flex-col items-center lg2:items-start '>
                        ...
                        <div className='flex justify-center flex-col sm:flex-row lg2:justify-start items-center lg2:text-left w-full gap-5 lg:gap-7 mt-5 lg:mt-[32px]'>
                            <div
                                className='bg-gradient-to-t from-[#CDB8FB] to-[#FFF] px-6 py-2 lg:px-5 rounded-3xl lg:py-2 text-black '>
                                <p className='text-sm md:text-lg leading-[150%] font-normal lg:font-semibold antialiased'>White Paper</p>
                            </div>
                            <div className=' mb-8 lg:mb-0 flex gap-2 lg:gap-3  justify-center items-center '>
                                {socialIcons.map((item, index) => (
                                    <button key={index} className=" gradient-hover-effect cursor-pointer inset-0 rounded-[100px] p-3 flex justify-center items-center"
                                        style={{
                                            backgroundImage: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.00) 71.35%, #5318D1 100%)',
                                        }}>
                                        <SocialIcons mode={item} size={1.3} />
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className='w-full px-6 2xl:px-8 flex pb-16 pt-2 items-center flex-col gap-3'>
                            ...
                            <div className='flex justify-between flex-1  w-full sm:w-full gap-3 '>
                                <div className='flex gap-3 items-center leading-[150%] justify-center bg-[#fff]/[0.07] plain_input w-full py-2 md:py-3 rounded-[30px]'>
                                    <ETHIcon size={2} />
                                    <p className='text-sm font-normal leading-[150%] antialiased'>ETH</p>
                                </div>
                                <div className='leading-[150%] flex gap-3 items-center justify-center bg-[#fff]/[0.07] plain_input w-full py-2 md:py-3 rounded-[30px]'>
                                    <USDTIcon size={2} />
                                    <p className='text-sm font-normal antialiased leading-[150%]'>USDT</p>
                                </div>
                            </div>
                            <div className='flex justify-between items-center flex-1  w-full sm:w-full gap-3'>
                                <div className='w-full '>
                                    <p className='mb-1 text-sm font-normal text-[#fff]/[0.6] text-center leading-[150%]'>ETH you pay</p>
                                    <div className='py-3  flex items-center px-4 bg-[#fff]/[0.07] plain_input w-full  rounded-[30px]'>
                                        <p className='text-[#AD87FF] text-lg  font-normal antialiased leading-[150%]'>0.0</p>
                                    </div>
                                </div>
                                <div className='w-full'>
                                    <p className='mb-1  text-sm font-normal text-[#fff]/[0.6] text-center leading-[150%]'>USDT you receive</p>
                                    <div className='py-3  flex items-center px-4 bg-[#fff]/[0.07] plain_input w-full rounded-[30px]'>
                                        <p className='text-[#AD87FF] text-lg  font-normal antialiased leading-[150%]'>0.0</p>
                                    </div>
                                </div>
                            ...
                            <div className='mt-4 flex justify-between items-center flex-1  w-full md:w-full gap-2 sm:gap-3'>
                                <button
                                    ...
                                    <p className='text-sm 2xl:text-base text-center font-normal antialiased leading-[150%]  '>Connect wallet</p>
                                </button>
                                <button className='gradient-hover-effect cursor-pointer py-3 bg-gradient-to-t from-[#775CF4] to-[#C85EF7] flex items-center justify-center px-1  md:px-4 bg-[#fff]/[0.07]  w-[133px] sm:w-full  rounded-[30px]'>
                                    <p className='text-sm 2xl:text-base text-center font-normal antialiased leading-[150%]  w-full'>Buy Crypto</p>
                                </button>
                            </div>
                        </div>
                    </div>
