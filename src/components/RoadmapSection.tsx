...
const Flag = () => (
    <div className="relative inset-0 rounded-[100px] flex-none h-[80px] w-[80px] md:h-[50px] md:w-[50px] 2xl:w-[66px] 2xl:h-[66px] top-10 flex justify-center items-center bg-black z-50"
        style={{
    ...
    >
        <SwiperSlide>
            <div className='flex flex-col items-center flex-1 h-full'>
                <p className='texttualgradient text-[28px] md:text-[42px] text-3xl xl:text-6xl font-semibold text-center'>2018</p>
                <Flag />
        ...
        <SwiperSlide>
            <div className='flex flex-col items-center flex-1'>
                ...
                <Flag />
                <Card hr={false} description='New Design Release of final version Pr-marketing campaign' />
            </div>
        </SwiperSlide>
    </Swiper>
)
    ...
    const RoadmapBubble = (): JSX.Element => {
        return (
            <div className='relative w-full flex flex-col gap-2'>
                ...
                <hr className='absolute top-[45%] left-[15%] h-1 w-[70%] mx-auto
