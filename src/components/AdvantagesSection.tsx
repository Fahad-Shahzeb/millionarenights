...
const AdvantagesSection = () => {
  const AdvantageBubble = ({
    ...
    title,
    subtitle,
  }: AdvantageBubbleProps): JSX.Element => {
    return (
      <div className='flex  gap-6 flex-col lg3:flex-row justify-center items-center '>
        <div
          className=' inset-0 rounded-full  p-5 md:p-3 w-[74px] h-[74px] md:w-[150px] md:h-[150px]  lg:w-[185px] lg:h-[185px]   flex justify-center items-center'
          style={{
            backgroundImage:
        ...
        >
          <img
            src={icon}
            className='w-[100%]  h-[100%] md:w-fit  md:h-fit'
            alt=''
          />
        </div>
        <div className='flex  justify-center flex-col w-[270px] md:w-[400px]'>
          <p className='text-[18px] sm:text-[28px] xl:text-[28px] text-center lg3:text-left font-normal antialiased uppercase'>
            {title}
          </p>
          <p className='text-[14px] sm:text-[16px] font-light text-center lg3:text-left text-[#989898]'>
            {subtitle}
          </p>
        </div>
      </div>
  ...
  const details = [
    {
      ...
      subtitle:
        'The blockchain technology and our internal advanced policies ensure complete transparency.',
    },
    {
      icon: IncomePNG,
      title: 'Continuous income from your share',
      subtitle:
        'From the 6th month of the launch, payments will be made in monthly cycles.',
    },
    {
      icon: ValuePNG,
      title: 'True Value',
      subtitle:
        'Our continuously operating dating system and the built-up brand is the value behind the token.',
    },
    {
      icon: InvestmentPNG,
      title: 'Investment Office',
      subtitle:
        'You can track your revenue, your share and other important information.',
    },
  ];
